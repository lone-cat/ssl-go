...
type saveFormat struct {
	...
	AllInOneFilename                 string `json:"allInOne"`
	PrivateKeyFilename               string `json:"privateKey"`
	CertificateFilename              string `json:"certificate"`
	PrivateKeyAndCertificateFilename string `json:"privateKeyAndCertificate"`
	IntermediateFilename             string `json:"intermediate"`
	IntermediatePattern              string `json:"intermediatePattern"`
	CertificateChainFilename         string `json:"certificateChain"`
}
